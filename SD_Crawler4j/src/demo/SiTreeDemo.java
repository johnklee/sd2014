...
public class SiTreeDemo {
	...
	public static void main(String[] args) throws Exception{
        ...
        Node node = siTree.dfsSearch("http://localhost/FF/EchoServlet/a1.html");
        if(node!=null) System.out.printf("\t[Test] Pass DFS Search!\n");
        else System.out.printf("\t[Test] Fail DFS Search!\n");
        // BFS
        ...
        //                       http://localhost/FF/SCServlet/404
        //                       http://localhost/FF/SCServlet/404
        if(node!=null) System.out.printf("\t[Test] Pass BFS Search!\n");
        else System.out.printf("\t[Test] Fail BFS Search!\n");
	}
